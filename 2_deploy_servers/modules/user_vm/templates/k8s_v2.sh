...
# Variables (update with Terraform datatemplate)
...
#--------------------------------------------------------------------------------------------------------------
# Create a non-expiring bootstrap token
#--------------------------------------------------------------------------------------------------------------
...
cat << EOF > /home/$LINUX_USER/export-cluster-info.py
${script}
EOF

# Run script
python3 /home/$LINUX_USER/export-cluster-info.py
...
# Deploy applications
#--------------------------------------------------------------------------------------------------------------
cat << EOF > /home/$LINUX_USER/app-deployment.yaml
${k8s_deployment}
EOF
kubectl apply -f /home/$LINUX_USER/app-deployment.yaml
